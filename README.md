...
Each classroom has one single way of teaching (e.g. multi-label) a certain subject matter (i.e. dataset), while allowing for different kinds of models to be evaluated through different tests. The point is to help teach humans to teach machines.
